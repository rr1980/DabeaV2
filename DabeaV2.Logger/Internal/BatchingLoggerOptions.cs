...
namespace DabeaV2.Logger.Internal
{
    public class BatchingLoggerOptions
    {
        ...
        private IDictionary<string, LogLevel> _filter = new Dictionary<string, LogLevel>();
        ...
        public IDictionary<string, LogLevel> LogLevel
        {
            ...
            set
            {
                _filter = value ?? throw new ArgumentNullException(nameof(value), $"{nameof(LogLevel)} can not be null.");
            }
        }

        public bool TryGetSwitch(string name, out LogLevel level)
        {
            return LogLevel.TryGetValue(name, out level);
        }
