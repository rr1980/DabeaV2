...
namespace DabeaV2.Logger
{
    ...
    public static class FileLoggerFactoryExtensions
    {
        ...
        //public static ILoggerFactory AddFile(this ILoggerFactory factory, Action<FileLoggerOptions> configure)
        //{
        //    factory.AddProvider(new FileLoggerProvider(configure));
        //    return factory;
        //}
    }
}